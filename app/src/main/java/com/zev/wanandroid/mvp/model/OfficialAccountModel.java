 ...
 */
@FragmentScope
public class OfficialAccountModel extends BaseModel implements OfficialAccountContract.Model {
    @Inject
    Gson mGson;
    @Inject
    ...
    @Inject
    public OfficialAccountModel(IRepositoryManager repositoryManager) {
    ...
    @Override
    public Observable<BaseArrayEntity<SetupEntity>> getWxOfficeTab() {
        return mRepositoryManager.obtainRetrofitService(HomeService.class).getWxOfficeTab();
    }
}