 ...
 */
@ActivityScope
public class MyShardModel extends BaseModel implements MyShardContract.Model {
    @Inject
    Gson mGson;
    @Inject
    ...
    @Inject
    public MyShardModel(IRepositoryManager repositoryManager) {
    ...
    @Override
    public Observable<BaseEntity<MyShareEntity>> getMyShard(int page) {
        return mRepositoryManager.obtainRetrofitService(UserService.class).getMyShard(page);
    }
}