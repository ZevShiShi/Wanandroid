...
import com.zev.wanandroid.mvp.presenter.WxChildPresenter;
 ...
 * ================================================
 */
public class WxChildFragment extends BaseMvpLazyFragment<WxChildPresenter> implements WxChildContract.View {

    @BindView(R.id.rv_wx_chapter)
    RecyclerView rvWxChapter;
    ...
    public static WxChildFragment newInstance(int chapterId) {
        WxChildFragment fragment = new WxChildFragment();
    ...
    public void setupFragmentComponent(@NonNull AppComponent appComponent) {
        DaggerWxChildComponent //如找不到该类,请编译一下项目
                .builder()
    ...
    public View initView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_wx_child, container, false);
    }
    ...
    protected void lazyLoadData() {
        int chapterId = getArguments().getInt("chapterId");
        rvWxChapter.setLayoutManager(new LinearLayoutManager(getContext()));
        mAdapter = new ChapterAdapter(R.layout.project_list_item);
        mAdapter.setEnableLoadMore(true);
        mAdapter.setOnLoadMoreListener(() -> {
            rvWxChapter.postDelayed(() -> {
