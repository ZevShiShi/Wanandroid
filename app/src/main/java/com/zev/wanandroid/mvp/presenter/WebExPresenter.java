 ...
 */
@ActivityScope
public class WebExPresenter extends BasePresenter<WebExContract.Model, WebExContract.View> {
    @Inject
    ...
    @Inject
    public WebExPresenter(WebExContract.Model model, WebExContract.View rootView) {
