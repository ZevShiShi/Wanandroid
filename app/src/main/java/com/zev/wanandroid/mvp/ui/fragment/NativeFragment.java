...
import com.zev.wanandroid.di.component.DaggerNativeComponent;
import com.zev.wanandroid.mvp.contract.NativeContract;
import com.zev.wanandroid.mvp.presenter.NativePresenter;
 ...
 * ================================================
 */
public class NativeFragment extends BaseMvpLazyFragment<NativePresenter> implements NativeContract.View {

    @BindView(R.id.navi_tab_layout)
    ...
    public void setupFragmentComponent(@NonNull AppComponent appComponent) {
        DaggerNativeComponent //如找不到该类,请编译一下项目
                .builder()
    ...
    public void initData(@Nullable Bundle savedInstanceState) {
        ...
        mAdapter.addFragment(SetupFragment.newInstance());
        mAdapter.addFragment(NavigationFragment.newInstance());
        vpNavigation.setAdapter(mAdapter);
        tabLayout.setViewPager(vpNavigation, new String[]{"体系", "导航"});
    }
